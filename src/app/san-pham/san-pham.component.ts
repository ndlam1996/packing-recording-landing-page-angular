...
export class SanPhamComponent {
  ...
  products: Product[] = [
    {
      ...
      soldCount: 1247,
      rating: 5,
      shopeeLink: 'https://shopee.vn/product/96640695/40517906413/'
    },
    {
      id: 2,
    ...
    },
    {
      ...
      soldCount: 432,
      rating: 4,
      shopeeLink: 'https://shopee.vn/product/96640695/44317897525/'
    },
    {
      id: 4,
      ...
      soldCount: 432,
      rating: 4,
      shopeeLink: 'https://shopee.vn/product/96640695/26841221807/'
    },
    {
      id: 5,
      ...
      soldCount: 632,
      rating: 5,
      shopeeLink: 'https://shopee.vn/product/96640695/41918813038/'
    },
    {
      id: 6,
      ...
      soldCount: 432,
      rating: 5,
      shopeeLink: 'https://shopee.vn/product/96640695/44168804011/'
    }
  ];
  ...
  copyShopeeLink(event?: Event) {
    if (event) {
      event.preventDefault();
      event.stopPropagation();
    }
    const shopeeUrl = this.selectedProduct?.shopeeLink || 'https://shopee.vn/quayvideodongdon';

    navigator.clipboard.writeText(shopeeUrl).then(() => {
      this.isCopied = true;
      // Reset sau 2 giây
      setTimeout(() => {
        this.isCopied = false;
